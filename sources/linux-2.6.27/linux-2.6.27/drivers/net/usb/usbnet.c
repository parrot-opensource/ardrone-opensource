...
#if defined(CONFIG_ARCH_VARIANT_PARROT6)
...
/* XXX quick hack until we understand why changing mac crash on rnb4 */
static int usbnet_mac_addr(struct net_device *dev, void *p)
{
...
#endif /* CONFIG_ARCH_VARIANT_PARROT6 */
...
// dma_supported() is deeply broken on almost all architectures
	...
	net->set_mac_address = usbnet_mac_addr;
