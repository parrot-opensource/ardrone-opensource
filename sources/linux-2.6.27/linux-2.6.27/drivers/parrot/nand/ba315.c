...
{
    {//Mode 0
        .twp = 50,      .twh = 50,  .trp = 50,  .treh = 50, .twsetup = 20,
        .trsetup = 60,  .twhr = 60, .tceh = 0,  .bta = 200, .tbusy = 0,
    },
    {//Mode 1
        .twp = 25,      .twh = 20,  .trp = 30,  .treh = 20, .twsetup = 10,
        .trsetup = 15,  .twhr = 65, .tceh = 0,  .bta = 100, .tbusy = 5,
    },
    {//Mode 2
        .twp = 17,      .twh = 18,  .trp = 25,  .treh = 15, .twsetup = 8,
        .trsetup = 10,  .twhr = 70, .tceh = 0,  .bta = 100, .tbusy = 10,
    },
    {//Mode 3
        .twp = 15,      .twh = 15,  .trp = 20,  .treh = 10, .twsetup = 10,
        .trsetup = 10,  .twhr = 50, .tceh = 0,  .bta = 100, .tbusy = 10,
    },
    {//Mode 4
        .twp = 12,      .twh = 13,  .trp = 20,  .treh = 10, .twsetup = 8,
        .trsetup = 10,  .twhr = 50, .tceh = 0,  .bta = 100, .tbusy = 10,
    },
    {//Mode 5
        .twp = 10,      .twh = 10,  .trp = 16,  .treh = 7,  .twsetup = 5,
        .trsetup = 10,  .twhr = 50, .tceh = 0,  .bta = 100, .tbusy = 10,
    },
};
...
static void ba315_onfi_set(struct mtd_info* mtd, int mode)
{
	...
	unsigned int hclk = NSEC_PER_SEC / clk_get_rate(ctrl->clk);
	...
	/* Update timing */
	tim =
		F_VAL(timing->twp / hclk, BA315_TIM0_TWP)           |
		F_VAL(timing->twh / hclk, BA315_TIM0_TWH)           |
		F_VAL(timing->trp / hclk, BA315_TIM0_TRP)           |
		F_VAL(timing->treh / hclk, BA315_TIM0_TREH)         |
		F_VAL(timing->twsetup / hclk, BA315_TIM0_TWSETUP)   |
		F_VAL(timing->trsetup / hclk, BA315_TIM0_TRSETUP)   |
		F_VAL(timing->twhr / hclk, BA315_TIM0_TWHR)         |
		F_VAL(timing->tceh / hclk, BA315_TIM0_TCEH);
	...
	tim =
		F_VAL(timing->bta / hclk, BA315_TIM1_BTA)           |
		F_VAL(timing->tbusy / hclk, BA315_TIM1_TBUSY);
