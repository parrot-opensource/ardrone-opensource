...
/**
 * nand_erase_bbt - [MTD Interface] erase block(s) with BBT refresh
 * @mtd:	MTD device structure
 * @instr:	erase instruction
 *
 * Erase one ore more blocks
 */
#if 1
static int nand_erase_bbt(struct mtd_info *mtd, struct erase_info *instr)
{
